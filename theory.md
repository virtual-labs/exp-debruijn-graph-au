...
<img src="images/new.jpg" title="" />

Figure 3. Construction of a de Bruijn graph from the target genome by splitting it into reads and k-mers

(Adapted from: Namiki, T., Hachiya, T., Tanaka, H. and Sakakibara, Y., 2011, August. MetaVelvet: an extension of Velvet assembler to de novo metagenome assembly from short sequence reads. In Proceedings of the 2nd ACM conference on bioinformatics, computational biology and biomedicine (pp. 116-124). ).
